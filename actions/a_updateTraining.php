...
if ($_POST) {
    ...
    $sql = "UPDATE kalender SET trainDate = '$trainDate', comment = '$comment' WHERE kalenderId = $kalenderId";
...
<?php
    if (mysqli_query($conn, $sql)) {
        ...
        echo "<h2>Training wurde erfolgreich aktualisiert </h2><br> <a href='../home.php'><button type='button' class='btn-warning rounded'>myHanno</button></a><br>";
